# Image Prompt for Observation #029

A boardroom-grade, high-fidelity LinkedIn card representing BRASA Field Observation #029.
...
*   **Visual Elements**:
    *   Top: Header ("BRASA FIELD OBSERVATION #029") in small uppercase Inter, followed by Title in large Cormorant Garamond, underlined by a 2px horizontal gold divider.
    *   Middle: Sans-serif bullet points separated by generous line-height spacing.
    *   Lower Middle: A center box outlined in a 3px gold border containing the bold uppercase statement: "PAPER RECEIVING LOGS LACK DATA INTEGRITY.".
