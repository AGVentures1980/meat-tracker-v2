...
app.use('/api/v1/inbound', requireAuth, inboundRoutes);
app.use('/api/v1/receiving', requireAuth, receivingRoutes);
app.use('/api/v1/production', requireAuth, productionRoutes);
...
app.use('/api/v1/store', requireAuth, storeRoutes);
app.use('/api/v1/regional', requireAuth, regionalRoutes);
