...
*Fixed Weight*: If NO T/WT= exists, look at the item description for pack sizes like '1/10' (10 lbs per case), '1/25' (25 lbs per case) or '4/10' (4x10=40 lbs per case). Calculate total lbs: Case Qty * lbs per case.
*OZ CALCULATION*: If the description has '96 3.6 OZ' (or OCR typos '963.6 OZ' or '963.6 OZTYSN'), calculate lbs: (96 * 3.6 / 16) = 21.6 lbs per case * Case Qty.
...
4. Common Abbreviations: 'Picanha' is 'Coulotte', 'COULOT', or 'BUTT CAP'. 'Fraldinha' is 'Flank'. 'Costela' or 'Beef Ribs' is 'SHORT RIB'. 'Chicken Breast' is 'CHICKEN CVP BRST', 'CHICKEN BRST' or 'BRST B/S' - do NOT skip Jumbo chicken breasts!`;
                        }
