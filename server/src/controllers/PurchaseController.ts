                ...
                try {
                    ...
                    if (isImage) {
                        ...
                        if (userCompanyId === 'fdc-main') {
                            ...
                            providerSpecificRules = `CRITICAL SYSCO INVOICE RULES:\n1. QUANTITY (LBS): Use T/WT= if present. If NO T/WT= exists (Fixed Weight), calculate total lbs by multiplying Case Qty by Pack Size (e.g. '1 CS' of '2 15 LB' or '2/15 LB' = 30 lbs). *WARNING*: DO NOT read '2 15 LB' as '215 LB'.\n2. PRICE: Extract unit price per lb, NOT the extended line total. If only Case Price is shown, divide Case Price by Total Lbs to get price_per_lb.\n3. Common Abbreviations: 'Picanha' is 'Coulotte' or 'COULOT'. 'Flank' is 'Fraldinha'. 'Beef Rib' is 'SHORT RIB'.`;
                        }
