        ...
        try {
            ...
            <html>
                ...
                <body>
                    ...
                    <div class="section-title">2. 90-Day Pilot Evaluation Scope</div>
                    <p>Licensor agrees to deploy the Brasa Meat Intelligence operating system to <span class="highlight">${contract.locations_count}</span> designated locations for a rigorous 90-Day evaluation. During this period, both parties agree to mutual confidentiality regarding proprietary business metrics, strategic workflows, and software interfaces (Mutual NDA).</p>
                    ` + (contract.contract_type === 'master' ? `
                    <div class="section-title">3. Commercial Terms & System Rollout</div>
                    <p>This Agreement covers the system implementation and active SaaS licensing for up to <span class="highlight">${contract.locations_count} Locations</span>. Post-Pilot physical hardware procurement is the sole responsibility of the Client.</p>
                    <ul style="font-size: 12px; margin-bottom: 15px; text-align: justify;">
                        <li><strong>Implementation Fee:</strong> A one-time setup and data onboarding fee of <span class="highlight">$${Number(contract.implementation_fee || 0).toLocaleString()}.00 USD</span> per location.</li>
                        <li><strong>SaaS Licensing Fee:</strong> A recurring software license of <span class="highlight">$${Number(contract.monthly_saas || 0).toLocaleString()}.00 USD</span> per location per month.</li>
                        <li><strong>Performance Participation:</strong> Licensor guarantees measurable yield savings and shall receive <span class="highlight">${contract.performance_share}%</span> of the verified gross meat savings generated.</li>
                    </ul>
                    ` : `
                    <div class="section-title">3. Pilot Hardware & Configuration Fee</div>
                    <p>To cover Capital Expenditure (CapEx) for physical hardware, travel, cloud provisioning, and on-site training, Client agrees to pay AGV Ventures a non-refundable Implementation & Setup Fee of <span class="highlight">$${Number(contract.implementation_fee || 25000).toLocaleString()}.00 USD</span>. AGV will provide proprietary "Turnkey Pilot Kits" (iPads, Pelican Cases, Zebra Scanners) to bypass internal procurement delays.</p>
                    
                    <div class="section-title">4. Enterprise SLA (Success Criteria)</div>
                    <p>This Pilot shall be deemed a "Success" if, at the conclusion of the 90-day period, the Software successfully proves that the Total Premium Meat Variance within the target Walk-in Cooler has stabilized at or below <span class="highlight">1.5% of Theoretical POS Sales</span>.</p>

                    <div class="section-title">5. Post-Pilot Commercial Rollout</div>
                    <p>Upon the successful validation of the SLA criteria defined above, the parties agree to escalate this pilot into a formal Enterprise Rollout governed by a Master SaaS Agreement, triggering tiered monthly SaaS licensing. No permanent SaaS fees are assessed until the Pilot SLA is fulfilled.</p>
                    `) + `
                    <div class="section-title">${contract.contract_type === 'master' ? '4. Liability Shield' : '6. Liability Shield'}</div>
