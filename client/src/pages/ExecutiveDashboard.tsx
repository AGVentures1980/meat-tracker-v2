...
import { ExecutiveTargetEditor } from '../components/ExecutiveTargetEditor';
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-gray-400">Company-wide Performance & Financial Impact</p>
                </div>
                            ...
                            <tbody className="divide-y divide-[#333]">
                                {top_savers.map((store) => (
                                    <tr key={store.id} className="hover:bg-white/5">
                                        ...
                                        <td className="px-4 py-3 text-right text-gray-400">{store.guests.toLocaleString()}</td>
