...
// Converts raw DB protein names like "ITEM_CHICKEN_BREAST" or "Beef Ribs" to "Chicken Breast"
const formatProteinName = (raw: string): string => {
    return raw
        .replace(/^ITEM_/i, '')          // strip leading ITEM_ prefix
...
export const WeeklyPriceInput = () => {
    ...
    const isExecutive = ['admin', 'director', 'area_manager', 'owner'].includes(user?.role || '');
