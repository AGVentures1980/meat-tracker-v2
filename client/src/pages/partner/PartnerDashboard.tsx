...
import { DollarSign, Building2, FileSignature, TrendingUp, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="bg-[#111] border border-gray-800 rounded-xl p-6 shadow-2xl">
                ...
                <div className="text-center py-12 text-gray-500 bg-[#0a0a0a] rounded-lg border border-dashed border-gray-800">
                    ...
                    <p className="text-sm mt-2">Click "New Client Proposal" to launch the TripleSeat Generator.</p>
                </div>
            </div>
        </div>
    );
